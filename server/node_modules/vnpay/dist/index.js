...
function Qe(r, n = "local") {
	...
	switch (n) {
		case "utc":
			return C.utc(u).toDate();
		case "gmt7": {
			let s = new Date(o, i, h, g, p, l);
			return C.utc(s).add(7, "hour").toDate();
		}
		case "local":
		default:
...
function k(r, n, e) {
	return J.createHmac(e, r).update(n.toString()).digest("hex");
}
function A() {}
function z(r, n = "log") {
...
function ee({ secureSecret: r, data: n, hashAlgorithm: e, bufferEncode: t }) {
	return J.createHmac(e, r).update(Buffer.from(n, t)).digest("hex");
}
function ne({ secureSecret: r, data: n, hashAlgorithm: e, receivedHash: t }) {
	return J.createHmac(e, r).update(Buffer.from(n, "utf-8")).digest("hex") === t;
}
var b = class {
...
export {
	xe as CURR_CODE_VND,
	G as GET_BANK_LIST_ENDPOINT,
	K as HashAlgorithm,
	Ce as InpOrderAlreadyConfirmed,
	De as IpnFailChecksum,
	Ae as IpnInvalidAmount,
	ke as IpnIpProhibited,
	Se as IpnOrderNotFound,
	Re as IpnSuccess,
	be as IpnUnknownError,
	B as PAYMENT_ENDPOINT,
	Y as ProductCode,
	R as QUERY_DR_REFUND_ENDPOINT,
	O as QUERY_DR_RESPONSE_MAP,
	U as REFUND_RESPONSE_MAP,
	M as RESPONSE_MAP,
	ue as RefundTransactionType,
	ye as TRANSACTION_STATUS_RESPONSE_MAP,
	pe as UrlService,
	f as VNPAY_GATEWAY_SANDBOX_HOST,
	Q as VNP_DEFAULT_COMMAND,
	S as VNP_VERSION,
	te as VNPay,
	he as VnpCardType,
	W as VnpCurrCode,
	I as VnpLocale,
	le as VnpTransactionType,
	m as WRONG_CHECKSUM_KEY,
	F as buildPaymentUrlSearchParams,
	ee as calculateSecureHash,
	z as consoleLogger,
	Z as createPaymentUrl,
	$ as dateFormat,
	We as fileLogger,
	Ye as generateRandomString,
	j as getDateInGMT7,
	y as getResponseByStatusCode,
	k as hash,
	A as ignoreLogger,
	H as isValidVnpayDateFormat,
	q as numberRegex,
	Qe as parseDate,
	d as resolveUrlString,
	ne as verifySecureHash,
